    ...
    <div className="mx-auto max-w-3xl px-6 py-20 md:px-10">
      ...
      <div className="space-y-10 text-[15px] leading-relaxed text-abyss/80">
        <Section title="1. Aceitação">
          <p>Ao criar uma conta ou usar o Prisma, você concorda com estes Termos. Se não concordar, não utilize o serviço.</p>
        </Section>

        <Section title="2. Sobre o serviço">
          <p>
            Prisma é uma ferramenta de Marketing Mix Modeling desenvolvida por Janilo Pereira Saraiva
            (J P Saraiva), sediado em São Paulo — SP. O serviço permite modelar a contribuição de canais
            de marketing a partir de planilhas de gastos e vendas.
          </p>
        </Section>
        ...
        <Section title="5. Limitação de responsabilidade">
          <p>
            ...
            decisões comerciais ou de investimento tomadas com base nos resultados gerados pelo Prisma.
          </p>
        </Section>
        ...
        <Section title="6. Privacidade">
          <p>
            ...
            <Link to="/privacidade" className="underline underline-offset-4 hover:text-indigo transition-colors">
        ...
        <Section title="7. Foro">
          <p>Estes Termos são regidos pelas leis brasileiras. Foro eleito: Comarca de São Paulo — SP.</p>
        </Section>
