  ...
  return (
    <article className="p-12 max-w-3xl">
      ...
      <Section title="Referências">
        <ul className="text-xs space-y-2 font-mono text-brand-navy/80 leading-relaxed">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mt-10">
      <h2 className="font-display text-2xl text-brand-navy border-b hairline-strong pb-2">{title}</h2>
      <div className="mt-4 text-sm leading-relaxed text-brand-navy/85 [&_strong]:text-brand-navy">
        {children}
      </div>
    </section>
  );
