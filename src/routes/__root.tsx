...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Suba uma planilha e veja o que de fato move suas vendas. MMM com Ridge, decomposição no tempo e ROI por canal." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Prisma · Marketing Mix Modeling" },
      { name: "twitter:description", content: "Suba uma planilha e veja o que de fato move suas vendas. MMM com Ridge, decomposição no tempo e ROI por canal." },
