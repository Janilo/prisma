...
const OG_IMAGE = "https://prisma.pereirasaraiva.com/og-social.png";
  ...
  head: () => ({
    meta: [
      { title: "Entrar · Prisma" },
      {
        name: "description",
        content:
          "Acesse o Prisma para rodar Marketing Mix Modeling: suba sua planilha de vendas e gastos e veja contribuição, ROI por canal e decomposição base vs. incremental.",
      },
      { property: "og:title", content: "Acesse sua conta no Prisma" },
      {
        property: "og:description",
        content:
          "Entre no Prisma e rode MMM com Ridge, adstock e saturação a partir da sua planilha.",
      },
      ...
      { name: "twitter:title", content: "Acesse sua conta no Prisma" },
      {
        ...
        content: "Entre no Prisma e rode MMM com Ridge, adstock e saturação.",
      },
      { name: "twitter:image", content: OG_IMAGE },
    ],
    links: [{ rel: "canonical", href: "https://prisma.pereirasaraiva.com/login" }],
  }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen bg-paper flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <p className="eyebrow">{mode === "signin" ? "Acessar conta" : "Criar conta"}</p>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24">
              ...
              <path
                fill="#fbbc04"
                d="M5.84 14.09a6.5 6.5 0 0 1 0-4.18V7.07H2.18a11 11 0 0 0 0 9.86l3.66-2.84Z"
              />
              <path
                fill="#ea4335"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end mt-1">
              <Link to="/forgot-password" className="text-xs text-mute hover:text-abyss">
                Esqueci a senha
              </Link>
            </div>
            <button
